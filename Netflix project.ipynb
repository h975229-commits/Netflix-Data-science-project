...
print("United States produces the highest amount of content.")

print("Most Netflix content was released after 2015.")

print("Ratings like TV-MA are very common on Netflix.")
